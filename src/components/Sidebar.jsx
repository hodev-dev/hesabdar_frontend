...
const Sidebar = () => {
  return (
    <div className={"flex flex-col w-2/12 h-auto bg-gray-200 no-print"}>
      <Link to={'/'}>
      ...
      <Link to={'/tahsimLabel'}>
        <button className={"w-full h-auto p-3 text-right border border-gray-300 font-small hover:bg-blue-800 hover:text-white"}>مدریت شرح تهسیم</button>
      </Link>
      {/* <Link to={'/tahsimLog'}>
